...
class GameObject():
    ...
    def __intersectsX(self, other):
        ...
        if self.__position[0] >= otherPosition[0] and self.__position[0] <= otherPosition[0] + otherSize[0]:
            return 1
        if (self.__position[0] + self.__size[0]) > otherPosition[0] \
                and (self.__position[0] + self.__size[0]) < (otherPosition[0] + otherSize[0]):
            return 1
        return 0
    ...
    def __intersectsY(self, other):
        ...
        if self.__position[1] >= otherPosition[1] and self.__position[1] <= otherPosition[1] + otherSize[1]:
            return 1
        if (self.__position[1] + self.__size[1]) > otherPosition[1] \
                and (self.__position[1] + self.__size[1]) < (otherPosition[1] + otherSize[1]):
            return 1
        return 0
